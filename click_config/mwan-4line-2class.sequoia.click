...
// TODO: fix IPEncap
c0_ds[0] -> c0_ah0 -> IPEncap(253, 192.168.35.2, 192.168.25.2) -> tun0;
c0_ds[1] -> c0_ah1 -> IPEncap(253, 192.168.36.2, 192.168.26.2) -> tun1;
c1_ds[0] -> c1_ah0 -> IPEncap(253, 192.168.35.2, 192.168.25.2) -> tun2;
c1_ds[1] -> c1_ah1 -> IPEncap(253, 192.168.36.2, 192.168.26.2) -> tun3;
