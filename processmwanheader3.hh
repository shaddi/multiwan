// -*- c-basic-offset: 4 -*-
#ifndef CLICK_PROCESSMWANHEADER3_HH
#define CLICK_PROCESSMWANHEADER3_HH
...
/*
  ...
  ProcessMWanHeader3(FLARESWITCH, PAINT_MAX, UPDATE_INT, DISTRIB_TOTAL,
  ...
  The FlareSwitch this element should control.
  ...
  The interval between updates of the FlareSwitch, assumed to be in milliseconds.
...
class ProcessMWanHeader3 : public Element {
public:
    ProcessMWanHeader3();
    ~ProcessMWanHeader3();

    const char *class_name() const { return "ProcessMWanHeader3"; }
    const char *port_count() const { return PORTS_1_1; }
    const char *processing() const { return AGNOSTIC; }
  
    int configure_phase() const { return FlareSwitch::CONFIGURE_PHASE + 1; }
